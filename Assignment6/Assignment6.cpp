...
void bubbleSort (int bubbleArray[],const int sizeOfArray)
{
    //int limbo=0;
    bool swapped=false;
...
void threeSortSubProgram (int arrayTBS, int sizeOfArray)        //use array size of "100" because " initializer fails to determine size of" error
{
